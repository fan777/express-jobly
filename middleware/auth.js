...
/** Middleware to use when user must be admin, or when logged in user matches parameter name
 * 
 * If not, raises Unauthorized.
 */
function ensureAdminOrLoggedUser(req, res, next) {
  try {
